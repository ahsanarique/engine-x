...
const TopNav = () => {
  ...
  return (
    <nav className="engine-x-topNav d-flex flex-column">
      <div className="top mb-auto">
        <div className="row mx-0">
          <div className="col-12">
            <Link to="/">
              <div className="engine-x-logo">
                <span>
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
                ...
                <span className="ps-2 title">EngineX</span>
                <span className="ps-2 small-text">No relations with SpaceX</span>
                </div>
              </div>
            </Link>
          </div>
      ...
      <div className="bottom mt-auto">
        <div className="row mx-0">
          ...
          />
          <TopNavItem
            routeLink="/project-data"
            title="Project Data"
            selected={currentLocation.pathname === "/project-data"}
            icon={dataIcon}
          />
        </div>
      </div>
